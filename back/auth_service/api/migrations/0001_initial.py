    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "formatted_address",
                    models.CharField(
                        help_text="Full formatted address from Google API",
                        max_length=255,
                    ),
                ),
                (
                    "street_number",
                    models.CharField(
                        blank=True, help_text="Street number", max_length=20, null=True
                    ),
                ),
                (
                    "route",
                    models.CharField(
                        blank=True, help_text="Street name", max_length=255, null=True
                    ),
                ),
                (
                    "locality",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "token_expiry",
                    models.DateTimeField(default=api.models.User.get_token_expiry),
                ),
